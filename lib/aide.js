...
(function(){
  ...
  function css(){
    ...
    st.textContent =
      ...
      // 40 px de haut minimum : un bouton de terrain se touche au pouce,
      // de nuit, à bout de bras — 31 px se manquait une fois sur trois
      'button.gb-aide{border-color:#2C383F;color:#7E8E96;font-size:11px;' +
      'padding:12px 13px;flex:none;min-width:0;min-height:40px}' +
