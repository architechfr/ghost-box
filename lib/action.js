/* ═══════════════════════════════════════════════════════════════════════
   ...
   La barre s'efface en écran fixe et en séance assise : ces modes ont déjà
...
window.GBAction = (function(){
  ...
  function css(){
    ...
    st.textContent =
      ...
      'body.filming #gbBarre,body.assis #gbBarre{display:none}' +
      'body.filming.avecbarre,body.assis.avecbarre{padding-bottom:0 !important}';
