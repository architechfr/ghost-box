...
window.GBFixe = (function(){
  ...
  css.textContent = [
    ...
    /* un bouton d'ACTION se reconnaît au ⟳ vert — mais il garde EXACTEMENT le
       gabarit des autres boutons du bandeau. La version « pastille plus
       grosse » se voyait mieux, et cassait la ligne : Voix et Nuit passaient
       dessous. Un bouton n'a pas le droit de coûter une ligne aux autres. */
    '.gbx-mods button.acte{border-color:#3E6B5A;color:#CFC6B4;text-transform:none;letter-spacing:.03em}',
    '.gbx-mods button.acte::before{content:"⟳ ";color:#5FD3A6}',
