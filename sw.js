...
const ENVELOPPE = [
  ...
  ...['moteur','mur','tampon','secours','pose','capture','wakelock','media','fullscreen','retour','aide','action','qr','spectre','capteurs','nuit','voix','historique','demarrage','installer','visage','fixe','objectif','croise','questions','planche','lettres','version','encodage','recit','lexique','torche','sillage','zone']
